...
And the final closure is the sum of the value within each segment,
\eqar{
...
\eqar{
  ...
  =&\ue^{\ui2\varphi_k^n}\int_{0}^{\tau_n}\!\!\ud t\ \paren{\Omega_n+\Omega'_nt}\ue^{\ui\delta_k^nt}\int_{0}^{t}\!\!\ud t'\ \paren{\Omega_n+\Omega'_nt'}\ue^{\ui\delta_k^nt'}\\
  =&\ue^{\ui2\varphi_k^n}\int_{0}^{\tau_n}\!\!\ud t\ \paren{\Omega_n+\Omega'_nt}\ue^{\ui\delta_k^nt}
  ...
  =&\frac{\ue^{\ui2\varphi_k^n}}{{\delta_k^n}^2}\int_{0}^{\tau_n}\!\!\ud t\paren{
    \paren{\Omega_n+\Omega'_nt}\paren{\paren{\Omega'_n-\ui\Omega_n\delta_k^n}-\ui\Omega'_n\delta_k^nt}\ue^{\ui2\delta_k^nt}-\paren{\Omega_n+\Omega'_nt}\paren{\Omega'_n-\ui\Omega_n\delta_k^n}\ue^{\ui\delta_k^nt}}\\
  =&\frac{\ue^{\ui2\varphi_k^n}}{{\delta_k^n}^2}
  \lparen{
    \Omega_n\paren{\Omega'_n-\ui\Omega_n\delta_k^n}F_0(2\delta_k^n, \tau_n)
    +\Omega'_n\paren{\Omega'_n-\ui2\Omega_n\delta_k^n}F_1(2\delta_k^n, \tau_n)
    -\ui{\Omega'_n}^2\delta_k^nF_2(2\delta_k^n, \tau_n)
  }\\
  &\rparen{
    -\paren{\Omega'_n-\ui\Omega_n\delta_k^n}
    \paren{\Omega_nF_0(\delta_k^n, \tau_n)+\Omega'_nF_1(\delta_k^n, \tau_n)}
  }\\
}
