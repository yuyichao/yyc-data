...
\eqar{
  &(a_0t^2 + b_0t + c_0)\ue^{\ui \paren{a_1 t + b_1}}
}
Symbolically evaluating this integral we have,
\eqar{
  &\int(a_0t^2 + b_0t + c_0)\ue^{\ui \paren{a_1 t + b_1}}\ud t\\
  =&\frac{\ui\ue^{\ui \paren{a_1 t + b_1}}}{a_1^3}\paren{a_0\paren{a_1^2t^2+2\ui a_1 t-2}+a_1\paren{a_1c_0+b_0\paren{a_1t+\ui}}}
}
