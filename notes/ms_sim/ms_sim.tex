...
If the two ions are seeing different amplitude but same frequency.

\eqar{
  \gamma_k^n\equiv&\int_{t_{n}}^{t_{n+1}}\!\!\ud t\ \Omega_1(t)\ue^{\ui\theta_{k}(t)}\int_{t_n}^{t}\!\!\ud t'\ \Omega_2(t')\ue^{-\ui\theta_{k}(t')}\\
  =&\int_{0}^{\tau_n}\!\!\ud t\ \paren{\Omega_{1n}+\Omega'_{1n}t}\ue^{\ui\delta_{k}^nt}\int_{0}^{t}\!\!\ud t'\ \paren{\Omega_{2n}+\Omega'_{2n}t'}\ue^{-\ui\delta_{k}^nt'}\\
  =&\int_{0}^{\tau_n}\!\!\ud t\ \paren{\Omega_{1n}+\Omega'_{1n}t}\ue^{\ui\delta_{k}^nt}
  \paren{\paren{\frac{\Omega'_{2n}+\ui\Omega_{2n}\delta_{k}^n}{{\delta_{k}^n}^2}+\ui\frac{\Omega'_{2n}t}{\delta_{k}^n}}\ue^{-\ui\delta_{k}^nt}-\frac{\Omega'_{2n}+\ui\Omega_{2n}\delta_{k}^n}{{\delta_{k}^n}^2}}\\
  =&\frac{1}{{\delta_{k}^n}^2}\int_{0}^{\tau_n}\!\!\ud t\ {}
  \paren{\Omega'_{2n}+\ui\Omega_{2n}\delta_{k}^n}\Omega_{1n}+
  \paren{\Omega'_{1n}\Omega'_{2n}+\ui\Omega'_{1n}\Omega_{2n}\delta_{k}^n
    +\ui\Omega_{1n}\Omega'_{2n}\delta_{k}^n}t\\
  &+\ui\Omega'_{1n}\Omega'_{2n}\delta_{k}^nt^2
  -\paren{\Omega'_{2n}+\ui\Omega_{2n}\delta_{k}^n}\paren{\Omega_{1n}+\Omega'_{1n}t}\ue^{\ui\delta_{k}^nt}\\
  =&\frac{1}{{\delta_k^n}^2}
  \lparen{
    \paren{\Omega'_{2n}+\ui\Omega_{2n}\delta_k^n}\Omega_{1n}\tau_n
    +\frac{1}{2}\paren{\Omega'_{1n}\Omega'_{2n}+\ui\Omega'_{1n}\Omega_{2n}\delta_{k}^n
    +\ui\Omega_{1n}\Omega'_{2n}\delta_{k}^n}\tau_n^2
    +\frac{1}{3}\ui\Omega'_{1n}\Omega'_{2n}\delta_k^n\tau_n^3}\\
  &\rparen{-\paren{\Omega'_{2n}+\ui\Omega_{2n}\delta_k^n}\Omega_{1n}\paren{F_0(\delta_k^n, \tau_n)-F_0(\delta_k^n, 0)}-\paren{\Omega'_{2n}+\ui\Omega_{2n}\delta_k^n}\Omega'_{1n}\paren{F_1(\delta_k^n, \tau_n)-F_1(\delta_k^n, 0)}}\\
  =&\frac{1}{{\delta_k^n}^2}
  \lparen{\paren{\Omega'_{2n}+\ui\Omega_{2n}\delta_k^n}\Omega_{1n}\tau_n
    +\frac{1}{2}\paren{\Omega'_{1n}\Omega'_{2n}+\ui\Omega'_{1n}\Omega_{2n}\delta_{k}^n
      +\ui\Omega_{1n}\Omega'_{2n}\delta_{k}^n}\tau_n^2
    +\frac{1}{3}\ui\Omega'_{1n}\Omega'_{2n}\delta_k^n\tau_n^3
  }\\
  &\rparen{+\frac{\ui}{{\delta_k^n}}\paren{\Omega'_{2n}+\ui\Omega_{2n}\delta_k^n}\Omega_{1n}\paren{\ue^{\ui{\delta_k^n}\tau_n}-1}
    -\paren{\Omega'_{2n}+\ui\Omega_{2n}\delta_k^n}\Omega'_{1n}
    \paren{\frac{-\ui{\delta_k^n}\tau_n + 1}{{\delta_k^n}^2}\ue^{\ui{\delta_k^n}\tau_n}
      -\frac{1}{{\delta_k^n}^2}}}
}
For an better expression around $\delta_k^n=0$,
\eqar{
  \gamma_k^n=&\frac{1}{{\delta_k^n}^2}
  \lparen{
    +\Omega_{1n}\Omega'_{2n}\frac{\ui}{2}\delta_{k}^n\tau_n^2
    \Omega'_{2n}\Omega_{1n}
    \frac{\delta_k^n\tau_n
      +\ui\paren{\cos\paren{{\delta_k^n}\tau_n}-1}
      -\sin\paren{{\delta_k^n}\tau_n}}{\delta_k^n}
    +\Omega_{2n}\Omega'_{1n}
    \paren{\frac{-{\delta_k^n}\tau_n - \ui}{{\delta_k^n}}\ue^{\ui{\delta_k^n}\tau_n}
      +\frac{\ui}{{\delta_k^n}}}
    +\ui\Omega_{2n}\Omega_{1n}\tau_n\delta_k^n
    +\frac{1}{2}\Omega'_{1n}\Omega'_{2n}\tau_n^2
    +\frac{\ui}{2}\Omega'_{1n}\Omega_{2n}\delta_{k}^n\tau_n^2
    +\frac{1}{3}\ui\Omega'_{1n}\Omega'_{2n}\delta_k^n\tau_n^3
  }\\
  &\rparen{
    -\Omega_{2n}\Omega_{1n}\paren{\ue^{\ui{\delta_k^n}\tau_n}-1}
    -\Omega'_{2n}\Omega'_{1n}
    \paren{\frac{-\ui{\delta_k^n}\tau_n + 1}{{\delta_k^n}^2}\ue^{\ui{\delta_k^n}\tau_n}
      -\frac{1}{{\delta_k^n}^2}}
  }
  \\
