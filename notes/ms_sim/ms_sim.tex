...
\eqar{
  ...
  =&\ue^{\ui\varphi_k^n}\paren{\Omega_nF_0(\delta_k^n, \tau_n)+\Omega'_nF_1(\delta_k^n, \tau_n)}
}
...
\eqar{
  ...
  =&\int_{0}^{\tau_n}\paren{\Omega_n+\Omega'_n t}\paren{t+t_n}\ue^{\ui\paren{\omega_kt+\varphi_k^n-\bar\omega_n t}}\ud t\\
  =&\ue^{\ui\varphi_k^n}\paren{\Omega_nt_nF_0(\delta_k^n, \tau_n)+\paren{\Omega_n+\Omega'_nt_n}F_1(\delta_k^n, \tau_n)+\Omega'_nF_2(\delta_k^n, \tau_n)}
}
...
\eqar{
  ...
  =&\ue^{\ui\varphi_k^n}\int_{0}^{\tau_n}\!\!\ud t
  ...
  =&\ue^{\ui\varphi_k^n}
  \paren{\frac{\Omega'_n-\ui\Omega_n\delta_k^n}{{\delta_k^n}^2}F_0(\delta_k^n, \tau_n)-\frac{\ui\Omega'_n}{\delta_k^n}F_1(\delta_k^n, \tau_n)-\frac{\Omega'_n-\ui\Omega_n\delta_k^n}{{\delta_k^n}^2}\tau_n}\\
}
