...
\eqar{
  H(t)=&\frac{\Omega(t)}{2}\sum_{j=1,2}\sum_{k}\eta_{jk}\lparen{(1+\varepsilon_j)\paren{a_k\ue^{-\ui\theta_k(t)}\sigma^j_++a_k^\dagger\ue^{\ui\theta_k(t)}\sigma^j_-}}\\
  &\rparen{+(1-\varepsilon_j)\paren{a_k^\dagger\ue^{\ui\theta_k(t)}\sigma^j_++a_k\ue^{-\ui\theta_k(t)}\sigma^j_-}} - \frac{\Delta_j}{2}\sigma_z^j\\
  =&\frac{\Omega(t)}{2}\sum_{j=1,2}\sum_{k}\eta_{jk}\paren{
