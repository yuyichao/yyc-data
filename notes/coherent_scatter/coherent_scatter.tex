...
We can compare this with the numerical simulation result~\ref{fig:compare-steady}
showing very good agreement.

\begin{figure}
  \centering
  \includegraphics[width=7cm]{../../euriqa/calculations/master_equation/imgs/coherent-scatter_det_theory.pdf}
