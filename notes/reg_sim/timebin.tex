...
The amplitude of the off-diagonal element quatifies the purity of the spin state
which is
\eqar{
...
spin phase factor as well\footnote{Basically the parity scan phase} that is
\eqar{
