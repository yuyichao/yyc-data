...
First we can bound the probability of the system being outside the perfectly correlated Hilbert space. If the probability of ion-photon pair $i=1,2$ being outside the correlated Hilbert space is $\varepsilon_{Ci}$,
