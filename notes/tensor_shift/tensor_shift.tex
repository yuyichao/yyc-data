...
\eqar{
  \langle F,m_F|d_q|F',m_F'\rangle=&\langle F||\mathbf{d}||F'\rangle\langle F,m_F|F',1;m_F',q\rangle\\
...
% Shift
From this, we can first calculate the stark shift for a pure
($\sigma^+$, $\pi$ or $\sigma^-$) polarization.
We only care about a single polarization and a single pair of state for each shift
so there's no summation. We'll also ignore the detuning
and all of the other pre-factors since we only care about
the ratio between different states/polaritions.
\eqar{
  \Delta E\propto&\langle F,m_F|d_q|F',m_F'\rangle\langle F',m_F'|d_q|F,m_F\rangle\\
  =&\langle F||\mathbf{d}||F'\rangle^2\abs{\langle F,m_F|F',1;m_F',q\rangle}^2\\
  =&\langle F||\mathbf{d}||F'\rangle^2\paren{2F+1}
  \begin{pmatrix}
    F'&1&F\\
    m_F'&q&m_F
  \end{pmatrix}^2
...
% Full matrix
Amplitude of the light $A_q$

\eqar{
  &\langle F,m_F|H|F',m_F'\rangle\\
  \propto&\sum_{F'',m_F'',q,q'}\langle F,m_F|A_qd_q|F'',m_F''\rangle\langle F'',m_F''|A_{q'}^*d_{q'}|F',m_F'\rangle\\
  \propto&\sum_{F'',m_F'',q,q'}A_qA_{q'}^*\langle F,m_F|F'',1;m_F'',q\rangle\langle F'',1;m_F'',q'|F',m_F'\rangle\\
  =&\sum_{k,p}T_p^k\sum_{F'',m_F'',q,q'}\langle k,p|1,1;q,q'\rangle\langle F,m_F|F'',1;m_F'',q\rangle\langle F'',1;m_F'',q'|F',m_F'\rangle\\
  =&T_0^0\sum_{F'',m_F'',q,q'}\langle 0,0|1,1;q,q'\rangle\langle F,m_F|F'',1;m_F'',q\rangle\langle F'',1;m_F'',q'|F',m_F'\rangle\\
  &+\sum_{p}T_p^1\sum_{F'',m_F'',q,q'}\langle 1,p|1,1;q,q'\rangle\langle F,m_F|F'',1;m_F'',q\rangle\langle F'',1;m_F'',q'|F',m_F'\rangle\\
  &+\sum_{p}T_p^2\sum_{F'',m_F'',q,q'}\langle 2,p|1,1;q,q'\rangle\langle F,m_F|F'',1;m_F'',q\rangle\langle F'',1;m_F'',q'|F',m_F'\rangle
}

\eqar{
  \langle F,m_F|V_q|F',m_F'\rangle=&\langle F||V||F'\rangle\langle F,1;m_F,q|F',m_F'\rangle\\
  \langle F,m_F|F_q|F,m_F'\rangle=&\langle F,m_F|F_q|F,m_F'\rangle
}
