...
\subsubsection{Diagonal terms (Stark shifts) only}
...
\eqar{
  \begin{split}
    \Delta E\propto&\langle F,m_F|d_{-q}|F',m_F'\rangle
                     \langle F',m_F'|d_{-q}|F,m_F\rangle\\
...
\subsubsection{Full effective Hamiltonian}
When the polarization of the light is not one of the pure polarizations,
the effect of the second order perturbation would contain off-diagnal terms in addition
...
\eqar{
  \begin{split}
    ...
    \propto&\sum_{m_F'',q,q'}\langle F,m_F|A_{q}d_{-q}|F'',m_F''\rangle\langle F'',m_F''|A_{-q'}^*d_{-q'}|F',m_F'\rangle\\
    \propto&\sum_{m_F'',q,q'}A_qA_{-q'}^*\langle F,m_F|F'',1;m_F'',-q\rangle\langle F'',1;m_F'',-q'|F',m_F'\rangle\\
    =&\sum_{k,p}T_p^k\sum_{m_F'',q,q'}\langle k,p|1,1;q,-q'\rangle\langle F,m_F|F'',1;m_F'',-q\rangle\langle F'',1;m_F'',-q'|F',m_F'\rangle\\
    =&T_0^0\sum_{m_F'',q,q'}\langle 0,0|1,1;q,-q'\rangle\langle F,m_F|F'',1;m_F'',-q\rangle\langle F'',1;m_F'',-q'|F',m_F'\rangle\\
    &+\sum_{p}T_p^1\sum_{m_F'',q,q'}\langle 1,p|1,1;q,-q'\rangle\langle F,m_F|F'',1;m_F'',-q\rangle\langle F'',1;m_F'',-q'|F',m_F'\rangle\\
    &+\sum_{p}T_p^2\sum_{m_F'',q,q'}\langle 2,p|1,1;q,-q'\rangle\langle F,m_F|F'',1;m_F'',-q\rangle\langle F'',1;m_F'',-q'|F',m_F'\rangle
  \end{split}
}
...
\eqar{
  \begin{split}
    H_{\text{s}}=&T_0^0\sum_{m_F'',q,q'}\langle 0,0|1,1;q,-q'\rangle\langle F,m_F|F'',1;m_F'',-q\rangle\langle F'',1;m_F'',-q'|F',m_F'\rangle\\
    =&T_0^0\sum_{m_F'',q}\langle 0,0|1,1;q,-q\rangle\langle F,m_F|F'',1;m_F'',-q\rangle\langle F'',1;m_F'',-q|F',m_F'\rangle\\
    =&T_0^0\sum_{q}\langle F,m_F|F'',1;m_F+q,-q\rangle\langle F'',1;m_F+q,-q|F',m_F'\rangle
  \end{split}
}
