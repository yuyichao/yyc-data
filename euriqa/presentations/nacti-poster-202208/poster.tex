  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colthreewid} % The third column
      \begin{block}{Imaging System}
        \begin{center}
          \begin{tikzpicture}
            \node at (0, 0) {\includegraphics[width=33cm]{imgs/imaging_system.png}};
            \node[text width=27cm,align=left] at (-2, -12.5) {
              \begin{itemize}
              ...
              \item PhotonGear optical lens design (0.63 NA) mounted on PI Hexapod for precise positioning
              \item Zemax simulations: the resulting Strehl ratio is >~0.95 for all 32 ions in the chain
              \end{itemize}
            };
            \node at (0, -28) {\includegraphics[width=27cm]{imgs/zeemax_sim.png}};
          \end{tikzpicture}
        \end{center}
      \end{block}
      ...
      \begin{block}{Applications}
        ...
        \begin{tikzpicture}
          ...
          \node at (24.5, -4.1) {\includegraphics[width=11.6cm]{imgs/app2.png}};
          \node[below,text width=15cm,align=left] at (11.5, 4.5) {
            \begin{itemize}
