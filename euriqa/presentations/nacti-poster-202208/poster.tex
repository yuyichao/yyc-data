  ...
  \begin{columns}[t]
    ...
    \begin{column}{\coltwowid}
      ...
      \begin{block}{Miniaturized 369/399/780/935nm Beam Path}
        \begin{center}
          \includegraphics[height=14cm]{imgs/AOSense_internal.jpg}
          \hspace{1cm}
          \includegraphics[height=13.5cm]{imgs/AOSense_external.png}
        \end{center}
      \end{block}
      \begin{block}{Control System}
        \begin{center}
          \begin{columns}[t]
            \begin{column}{0.38\coltwowid}
              \begin{subblock}{ARTIQ}
                ...
                \vspace{0.3cm}
                \begin{center}
                  \includegraphics[width=13.5cm]{imgs/artiq_hardware.png}
                \end{center}
              \end{subblock}
              \begin{subblock}{RFSoC/Pentek}
                ...
                \end{itemize}
                \begin{center}
                  \includegraphics[width=13.5cm]{imgs/pentek.png}
                \end{center}
              \end{subblock}
            \end{column}
            \begin{column}{0.55\coltwowid}
              \begin{subblock}{Duke Artiq Extensions}
                ...
                \vspace{0.7cm}
                \begin{center}
                  \includegraphics[width=22cm]{imgs/dax.pdf}
                \end{center}
              \end{subblock}
            \end{column}
          \end{columns}
