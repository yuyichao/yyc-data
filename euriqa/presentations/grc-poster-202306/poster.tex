    ...
    \begin{column}{\colonewid} % The first column
      ...
      \begin{block}{Phoenix Surface Trap}
        \begin{tikzpicture}
          ...
          \node at (8, -22.5) {\includegraphics[width=16cm]{imgs/heating-rate.pdf}};

          \node at (7.5, -33) {\includegraphics[width=30cm]{imgs/center_voltage.pdf}};

          \fill[semgray,opacity=0.6] (13.03, -31.72)
          -- (17, -29.25) -- (23.5, -29.25) -- cycle;
          \fill[semgray!90!blue,opacity=0.6] (-2.47, -31.72)
          -- (-1, -29.25) -- (-7.5, -29.25) -- cycle;

          \node at (-4.25, -26) {\includegraphics[width=6.5cm]{imgs/three_ions.png}};
          \node at (20.25, -26) {\includegraphics[width=6.5cm]{imgs/quantum_ion.png}};
        \end{tikzpicture}
      \end{block}
