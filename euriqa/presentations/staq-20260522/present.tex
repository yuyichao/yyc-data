...
\begin{frame}
  \begin{center}
    \begin{tikzpicture}
      ...
      \node[below right] at (-6, 3) {\includegraphics[width=2.1cm]{qsim_coupling_com.png}\hspace{0.6cm}\includegraphics[width=2.1cm]{qsim_coupling_zigzag.png}};
      ...
      \node[below right] at (-6, -0.5) {\includegraphics[width=2.1cm]{qsim_coupling_20251030.png}\hspace{0.6cm}\includegraphics[width=2.1cm]{qsim_coupling_202510.png}};
