  ...
  \begin{columns}[t]
      ...
      \begin{block}{System Performance}
        \begin{center}
          \begin{subblock}{Single qubit gates}
            \begin{columns}
              \column{16cm}
              \includegraphics[width=15cm]{imgs/rb_fit}
              \column{16cm}
              \begin{itemize}
              \item Robust SK1 composite pulse
              \item Random benchmark
              \end{itemize}
            \end{columns}
          \end{subblock}
          \begin{subblock}{Two qubit gates}
            ...
            \end{columns}
          \end{subblock}
          \begin{subblock}{Axial temperature}
            \begin{columns}
              \column{16cm}
              % TODO
              % \includegraphics[width=16cm]{imgs/}
              \column{16cm}
              \begin{itemize}
    ...
    \begin{column}{\coltwowid} % The second column
      ...
      \begin{block}{Quantum simulation in 1D ion chains}
        ...
        \begin{center}
          \begin{tikzpicture}
            \node at (-8, 0) {\includegraphics[width=16cm]{imgs/qsim_coupling_com}};
            \node at (8, 0) {\includegraphics[width=16cm]{imgs/qsim_coupling_zigzag}};
          \end{tikzpicture}
        \end{center}
      \end{block}
      \vspace{0.5cm}
