...
\begin{tikzpicture}
  ...
  % Bracket
  \node[right] at (1.6, 5.7) {$[3/2]_{1/2}\ \ F=1$};
  \mytweezer.drawState(\Bx-\Zx, \By-\Zy)
  \mytweezer.drawState(\Bx, \By)
  \mytweezer.drawState(\Bx+\Zx, \By+\Zy)

  % D
  \node[right] at (\Dx+\Zx*2 + 0.2, \Dy - 0.2) {$\mathrm{D}_{3/2}\ \ F=2$};
  ...
  (\Dx, \Dy + 0.1) -- (\Bx + 0.1, \By - 0.2);
  \draw[cyan, ->, snakearrow, >=stealth, line width=1]
  (\Bx - 0.1, \By - 0.2) -- (\Sx - \Zx, \Sy + 1.5);
  \draw[cyan, ->, snakearrow, >=stealth, line width=1]
  (\Bx - 0.06, \By - 0.2) -- (\Sx, \Sy + 1.5);
  \draw[cyan, ->, snakearrow, >=stealth, line width=1]
  (\Bx - 0.02, \By - 0.2) -- (\Sx + \Zx, \Sy + 1.5);
