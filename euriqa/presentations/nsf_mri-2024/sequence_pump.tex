...
\begin{tikzpicture}
  \begin{scope}[shift={(0, -1.5)}]
    \fill[color=pyplotc4] (-9.5, 0) rectangle (-7, -0.9)
    node[white,pos=.5,align=center] {To dressed\\ eigenstates};

    \fill[color=pyplotc4] (-6.5, 0) rectangle (6.5, -0.9)
    node[white,pos=.5,align=center] {Raman Dressing};

    \fill[color=pyplotc4] (7, 0) rectangle (9.5, -0.9)
    node[white,pos=.5,align=center] {To undressed\\ eigenstates};

    \fill[color=pyplotc0] (-6.4, 0) rectangle (-5, 0.9)
    node[white,pos=.5,align=center] {Drive\\to $D_{3/2}$};
    \fill[color=pyplotc3] (-4.9, 0) rectangle (-3.5, 0.9)
    node[white,pos=.5,align=center] {Pump\\to $S_{1/2}$};

    \fill[color=pyplotc0] (-3.4, 0) rectangle (-2, 0.9)
    node[white,pos=.5,align=center] {Drive\\to $D_{3/2}$};
    \fill[color=pyplotc3] (-1.9, 0) rectangle (-0.5, 0.9)
    node[white,pos=.5,align=center] {Pump\\to $S_{1/2}$};

    \node at (1.5, 0.45) {\Huge $\mathbf{\cdots}$};

    \fill[color=pyplotc0] (3.5, 0) rectangle (4.9, 0.9)
    node[white,pos=.5,align=center] {Drive\\to $D_{3/2}$};
    \fill[color=pyplotc3] (5.0, 0) rectangle (6.4, 0.9)
    node[white,pos=.5,align=center] {Pump\\to $S_{1/2}$};
