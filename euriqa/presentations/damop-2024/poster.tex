      ...
      \begin{block}{Preliminary results}
        ...
        \begin{center}
          \begin{subblock}{Mid circuit measurement}
            \vspace{0.5cm}
            \begin{tikzpicture}
              \node at (-8, 7.1) {Auxiliary qubit detection fidelity};
              \node[left] at (0, 0) {\includegraphics[width=18cm]{imgs/data_20240524_spec_dressed.pdf}};
              \node[right,text width=18cm,align=center] at (0, 1) {
                \begin{itemize}
                \item Detection time $130\ \mathrm{\mu m}$
                \item Detection fidelity \textcolor{red}{100\%}
          ...
          \begin{subblock}{Data qubit coherence}
            ...
            \begin{tikzpicture}
              ...
              node[white,pos=.5] {Partion detection};
              \draw[-{Stealth[length=15mm,width=7mm]},line width=5] (-14, -3) node[left] {Aux} -- (19, -3);
              \node at (-7.3, -5.4) {Data qubit Ramsey};
              \node[left] at (0.7, -12.5) {\includegraphics[width=18cm]{imgs/data_20240524_spec_dressed.pdf}};
              \node at (10.3, -5.4) {Data qubit fidelity};
              \node[right] at (0.3, -12.5) {\includegraphics[width=18cm]{imgs/data_20240524_spec_dressed.pdf}};
              \node[below,text width=35cm,align=center] at (0, -20) {
                \begin{itemize}
                \item Data qubit coherence \textcolor{red}{100\%}
                \item Limited by single qubit control
                \item Optical qubit coherence time
                \item Effect of re-scattering
                \end{itemize}
              };
            \end{tikzpicture}
          \end{subblock}
