...
% a trapped chain of 5-30 Yb/Ba ions.
...
% with physical separation. or by using multiple ion species that uses different
% measurement and reset wavelengths.

% requires complex structure/more ions/time
