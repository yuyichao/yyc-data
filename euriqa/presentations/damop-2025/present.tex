...
\begin{frame}{Duke Quantum Center \visible<2->{--- Gold System}}
  \begin{center}
    \begin{tikzpicture}
      ...
      \begin{scope}[shift={(-4, -0.3)}]
        ...
        \node[pyplotc5] at (-0.8, -1.1) {\textbf{brown \scalebox{0.8}{(Yb)}}};
      \end{scope}
...
\begin{frame}{}
  \begin{center}
    \begin{tikzpicture}
      ...
      \visible<2-> {
        \node at (6.6, 1.2) {\includegraphics[width=7.5cm]{imgs/sequence.pdf}};
      }
      \visible<3-> {
    ...
    \begin{tikzpicture}
      \begin{scope}[scale=0.5]
        ...
        \begin{scope}[shift={(0, 0.6)}]
          ...
          \node[right] at (\Dx+\Zx*2 + 0.35, \Dy-0.4) {\scalebox{0.8}{$F=2$}};
