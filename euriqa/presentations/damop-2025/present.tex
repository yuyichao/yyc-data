...
\begin{frame}{Mid-circuit measurement and reset (MCMR)}
  \begin{center}
    \begin{tikzpicture}
      ...
      \visible<4->{
        \node[align=left,text width=5cm,inner sep=0,outer sep=0] at (6, -2) {
          \begin{itemize}
...
\begin{frame}{Individual control of metastable state}
  \begin{center}
    ...
    \end{tikzpicture}
  \end{center}
  % TODO: Dressing energy diagram
  % TODO: Raman dressing?
  % TODO: Dressed spectrum

  % TODO: Qubit rotation method (qudit diagram)
  % TODO: Example sequence

  % TODO: Method combination table
\end{frame}
