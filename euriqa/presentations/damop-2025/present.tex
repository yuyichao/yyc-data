...
% In general, this can be achieved by dressing a target ion, usually the auxiliary ion,
% using the individual gate control. The dressing can selectively shift the resonance of
...
% Here's what that spectrum look like.
