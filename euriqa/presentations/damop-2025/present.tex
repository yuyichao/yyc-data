...
\begin{frame}{}
  \begin{center}
    ...
    \begin{tikzpicture}
      \visible<2-> {
        \node[below,align=center] at (7.8, 5.8)
        {\usebeamercolor[fg]{frametitle}{\bf Mid-circuit measurement}};
      }
      \visible<1-2> {
        ...
        \end{scope}
        \node at (0.5, -0.9) {\scalebox{0.7}{$t_2^{|D\rangle}\approx10\ \mathrm{ms}$}};
        \node at (0.5, 4.7) {\scalebox{1}{$^{171}\mathrm{Yb}^+$ levels}};
      }
      \visible<2-> {
