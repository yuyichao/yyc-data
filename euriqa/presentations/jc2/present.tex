...
% Sideband coupling
% OP heating (remaining in the same state vs heating)
% Effective LD parameter (wavefunction get larger)

% LD approximation
% For motional spectroscopy
% For MS gate (not needed for uwave gate)
