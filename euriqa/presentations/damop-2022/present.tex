    ...
    \begin{columns}
      ...
      \begin{block}{}
        ...
        \item Long coherence time: $T_2\approx1 \text{hr}$\\
          ...
          \vspace{1em}
        \item High fidelity state preparation: $> 99.9\%$ in $\approx 10 \mu s$
        \item High speed and high fidelity readout: $> 99.3\%$ in $\approx 100 \mu s$\\
          \vspace{0.5em}
...
\begin{frame}{$2^{\text{nd}}$ generation EURIQA system}
  \begin{center}
    \begin{tikzpicture}
      \node at (0, 0) {\includegraphics[width=5.4cm]{imgs/Brassboard_render}};
