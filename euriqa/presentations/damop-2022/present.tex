...
% These laser systems requires relatively low maintanance,
...
% There has already been many results from it,
...
% that's limitting the useful time and ion chain length.
%
