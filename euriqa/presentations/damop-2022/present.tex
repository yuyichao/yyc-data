...
%% Title
% I'm Yichao from the Monroe group at Duke and today I'll tell you about
% our second generation quantum computing experiment.
...
% It got a electronic ground state with a J=1/2 and I=1/2 meaning that we have
% a pair of mF=0 states that are insensitive to the B field to the first order,
% which has allowed people to achieve a very long coherence time of ~1hr.
% It also has a mostly cycling optical transition at 369nm which we can use to
...
% fine control on the axial position of the ions.
...
% In order to entangle these qubits, we use the momentum kicks
% from our Raman beam to implement a MS gate using the radial mode of
...
% a few limitations of our system that affects the maximum size and fidelity
...
% based on what we've learnt and this is what I'm going to focus on
