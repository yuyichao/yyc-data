...
% There has already been many results from this system,
% and you can hear more about them many other talks in this conference
...
% It also comes with segmented outter electrodes which should allow us
% to compensate for the micromotion more precisely across the whole chain.
...
% allowing loading and shuttling of multiple ions simutaniously.
...
%% New oven
% In the 1st gen experiment, we demostrated an improvment in gate fidelity and
...
% by changing the frequency of our 399 ionization laser.
% This should help us construct the chain with the desired composition
% for sympathetic cooling more deterministically.
...
% Although not directly related to gate fidelity, it should
% improve upon the 4-5min time between collisions measured in our first gen system
% that's limitting our usable time and ion chain length.
%
...
% as you can see in this photo. Here you can see our vacuum chamber,
% with connection for DC and RF electrodes as well as the delivery beam path
% for the CW lasers mounted on it in the middle and in the foreground,
% and the Raman beam path from L3Harris in the black boxes are surrounding the chamber
% and in the back, as you've already seen in an earlier slide.
%
