      ...
      \begin{block}{MCMR without individual detection beams}
        \begin{center}
          \begin{tikzpicture}
            ...
            \node[right] at (0, 0) {\includegraphics[width=19cm]{imgs/fig-mcmr-methods.pdf}};
          \end{tikzpicture}
        \end{center}
      \end{block}
          ...
          \begin{subblock}{Mid-circuit measurement}
            ...
            \begin{center}
              \begin{tikzpicture}
                ...
                \node at (-7.9, -8) {Detection fidelity: $99.6(2)\ \%$};
                \node at (-9, -15) {\includegraphics[width=18cm]{imgs/detect_aux_rabi.pdf}};
                \node at (10.1, -8) {Data coherence: $98.5(6)\ \%$};
                \node at (9, -15) {\includegraphics[width=18cm]{imgs/detect_data_ramsey_square.pdf}};
              \end{tikzpicture}
            \end{center}
          \end{subblock}
