...
\begin{frame}{$2^{\text{nd}}$ gen EURIQA: Improved vacuum}
  \begin{center}
    \begin{columns}
      ...
      \item<3-> $1.32(21)\times10^{-11}\ \mathrm{Torr}$ measured pressure
      \end{itemize}
      \visible<3->{
        \begin{center}
          \includegraphics[width=5cm]{imgs/double-well.pdf}
        \end{center}
      }
      \column{5.1cm}
...
\begin{frame}{$2^{\text{nd}}$ gen EURIQA: Phoenix trap}
  \begin{center}
    \begin{tikzpicture}
      ...
      \visible<2-3>{
        \node at (-2.5, -2) {\includegraphics[width=6.6cm]{imgs/heating-rate}};
      }
