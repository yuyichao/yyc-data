...
\begin{frame}{$2^{\text{nd}}$ gen EURIQA: Qubit coherence}
  \begin{center}
    \begin{tikzpicture}
      \visible<2->{
        \node at (3, 2) {\includegraphics[width=6.8cm]{imgs/t2}};
      }
      \node[text width=4.5cm] at (-3, 3) {
        \begin{itemize}
        \item<1-> Ramsey experiment\\
          using microwave
        \item<2-> $t_2=2.68(36)\ s$
        \item<3-> Can be further improved with shielding
        \end{itemize}
      };
    \end{tikzpicture}
  \end{center}
