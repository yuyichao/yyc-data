...
\begin{tikzpicture}[scale=0.4]
  ...
  \draw[<->, dashed, >=stealth, blue, line width=1] (S00) --
  node[pos=0.6,sloped,align=center,execute at begin node=\setlength{\baselineskip}{6pt}]
  {\tiny Dynamical\\\tiny Decoupling} (D20);
\end{tikzpicture}
\end{document}
