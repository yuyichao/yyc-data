...
const prefix = joinpath(@__DIR__, "imgs", "data_20241010_pump_square")

const inames = ["000077469-Raman435MidCircuitScan.h5",
                "000077473-Raman435MidCircuitScan.h5"]
...
const data_rabi_0 = [datas_0[2][1], datas_0[2][3], datas_0[2][5], datas_0[2][7]]
const data_rabi_1 = [datas_0[2][2], datas_0[2][4], datas_0[2][6], datas_0[2][8]]
...
const data_ramsey_0 = [[datas_0[1][1]; datas_0[2][9]],
                       [datas_0[1][3]; datas_0[2][11]],
                       [datas_0[1][5]; datas_0[2][13]],
                       [datas_0[1][7]; datas_0[2][15]]]
const data_ramsey_1 = [[datas_0[1][2]; datas_0[2][10]],
                       [datas_0[1][4]; datas_0[2][12]],
                       [datas_0[1][6]; datas_0[2][14]],
                       [datas_0[1][8]; datas_0[2][16]]]
...
const aux_rabi_0 = [[datas_1[1][9]; datas_1[2][17]],
                    [datas_1[1][11]; datas_1[2][19]],
                    [datas_1[1][13]; datas_1[2][21]],
                    [datas_1[1][15]; datas_1[2][23]]]
const aux_rabi_1 = [[datas_1[1][10]; datas_1[2][18]],
                    [datas_1[1][12]; datas_1[2][20]],
                    [datas_1[1][14]; datas_1[2][22]],
                    [datas_1[1][16]; datas_1[2][24]]]
