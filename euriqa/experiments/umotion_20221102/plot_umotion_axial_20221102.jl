...
text(-10, 0.4, "\$V_{min1}=$(fit_amp_1.uncs[3])\$ V", color="C0")
text(-10, 0.35, "\$V_{min2}=$(fit_amp_2.uncs[3])\$ V", color="C1")
grid()
xlabel("DY (V/m)")
ylabel("Amplitude")
...
text(-10, 0.4, "\$V_{min1}=$(fit_amp_3.uncs[3])\$ V", color="C0")
text(-10, 0.35, "\$V_{min2}=$(fit_amp_4.uncs[3])\$ V", color="C1")
grid()
xlabel("DY (V/m)")
ylabel("Amplitude")
