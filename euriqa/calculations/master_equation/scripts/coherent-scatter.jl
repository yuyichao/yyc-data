...
figure()
plot(dets, get_22_coherent.(2π * 0.1, dets, 2π * 0.02, 5), "C0", label="t=5")
plot(dets, get_22_independent.(2π * 0.1, dets, 2π * 0.02, 5), "C0--", label="t=5")
plot(dets, get_22_coherent.(2π * 0.1, dets, 2π * 0.02, 15), "C1", label="t=15")
plot(dets, get_22_independent.(2π * 0.1, dets, 2π * 0.02, 15), "C1--", label="t=15")
plot(dets, get_22_coherent.(2π * 0.1, dets, 2π * 0.02, 35), "C2", label="t=35")
plot(dets, get_22_independent.(2π * 0.1, dets, 2π * 0.02, 35), "C2--", label="t=35")
plot(dets, get_22_coherent.(2π * 0.1, dets, 2π * 0.02, 75), "C3", label="t=75")
plot(dets, get_22_independent.(2π * 0.1, dets, 2π * 0.02, 75), "C3--", label="t=75")
ylim([0, 1])
grid()
