...
# const sys_1 = get_sys(2π * 1, 0, B0)
# const sys_2 = get_sys(2π * 2, 0, B0)
# const sys_5 = get_sys(2π * 5, 0, B0)
# const sys_10 = get_sys(2π * 10, 0, B0)
# const sys_20 = get_sys(2π * 20, 0, B0)
# const sys_50 = get_sys(2π * 50, 0, B0)
# const sys_100 = get_sys(2π * 100, 0, B0)
# const sys_200 = get_sys(2π * 200, 0, B0)
# const sys_500 = get_sys(2π * 500, 0, B0)

# const ts = range(0, 10, 2001)
