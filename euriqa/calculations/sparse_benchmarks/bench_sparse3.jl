...
function bench_sparse(C, X, A)
    ...
    @btime spmul_adj_orig2($C, $(adjoint(X)), $A, $(true), $(false))
    ...
    @btime spmul_adj_orig2($C, $(transpose(X)), $A, $(true), $(false))
    ...
    @btime spmul_adj_orig2($C, $(adjoint(X)), $A, $(true), $(true))
    ...
    @btime spmul_adj_orig2($C, $(transpose(X)), $A, $(true), $(true))
