...
@inline _sin_f1_small(x::T) where T =
    x * evalpoly(x^2, 1 / T(6), -1 / T(120), 1 / T(5_040), -1 / T(362_880),
                 1 / T(39_916_800), -1 / T(6_227_020_800), 1 / T(1_307_670_368_000))
@inline _sin_f1_big(x, s, c) = (x - s) / x^2
@_combined_func sin_f1

# (2 * cos(x) - 2 + x * sin(x)) / x^3
@inline _cos_f2_small(x::T) where T =
    x * evalpoly(x^2, -1 / T(12), 1 / T(180), -1 / T(6_720), 1 / T(453_600),
                 -1 / T(47_900_160), 1 / T(7_264_857_600), 1 / T(1_494_484_992_000))
...
@inline _sin_f3_small(x::T) where T =
    x * evalpoly(x^2, 1 / T(30), -1 / T(840), 1 / T(45_360), -1 / T(3_991_680),
                 1 / T(518_918_400), -1 / T(93_405_312_000), 1 / T(22_230_464_256_000))
