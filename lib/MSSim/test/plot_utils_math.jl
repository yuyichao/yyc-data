...
const sin_f4_x, sin_f4_d64_small, sin_f4_d64_big, sin_f4_d32_small, sin_f4_d32_big =
    compute_diffs(MSSim.Utils._sin_f4_small, MSSim.Utils._sin_f4_big)

figure(figsize=[6.4 * 2, 4.8])

subplot(1, 2, 1)
plot(sin_f4_x, sin_f4_d64_big, label="big")
plot(sin_f4_x, sin_f4_d64_small, label="small")
legend(fontsize=10, ncol=2)
ylim([0, 1e-15])
ylabel("Error")
title("sin_f4 64")
...
subplot(1, 2, 2)
plot(sin_f4_x, sin_f4_d32_big, label="big")
plot(sin_f4_x, sin_f4_d32_small, label="small")
legend(fontsize=10, ncol=2)
ylim([0, 4e-7])
ylabel("Error")
title("sin_f4 32")
...
const sin_f5_x, sin_f5_d64_small, sin_f5_d64_big, sin_f5_d32_small, sin_f5_d32_big =
    compute_diffs(MSSim.Utils._sin_f5_small, MSSim.Utils._sin_f5_big)

figure(figsize=[6.4 * 2, 4.8])

subplot(1, 2, 1)
plot(sin_f5_x, sin_f5_d64_big, label="big")
plot(sin_f5_x, sin_f5_d64_small, label="small")
legend(fontsize=10, ncol=2)
ylim([0, 1e-15])
ylabel("Error")
title("sin_f5 64")
...
subplot(1, 2, 2)
plot(sin_f5_x, sin_f5_d32_big, label="big")
plot(sin_f5_x, sin_f5_d32_small, label="small")
legend(fontsize=10, ncol=2)
ylim([0, 4e-7])
ylabel("Error")
title("sin_f5 32")
