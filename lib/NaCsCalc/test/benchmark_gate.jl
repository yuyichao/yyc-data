...
println("SXGate")
@btime benchmark($(state1_1), Clf.SXGate())
@btime benchmark($(state1_2), Clf.SXGate())
@btime benchmark($(state1_3), Clf.SXGate())
@btime benchmark($(state2_1), Clf.SXGate())
@btime benchmark($(state2_2), Clf.SXGate())
@btime benchmark($(state2_3), Clf.SXGate())
...
println("ISXGate")
@btime benchmark($(state1_1), Clf.ISXGate())
@btime benchmark($(state1_2), Clf.ISXGate())
@btime benchmark($(state1_3), Clf.ISXGate())
@btime benchmark($(state2_1), Clf.ISXGate())
@btime benchmark($(state2_2), Clf.ISXGate())
@btime benchmark($(state2_3), Clf.ISXGate())
...
println("SYGate")
@btime benchmark($(state1_1), Clf.SYGate())
@btime benchmark($(state1_2), Clf.SYGate())
@btime benchmark($(state1_3), Clf.SYGate())
@btime benchmark($(state2_1), Clf.SYGate())
@btime benchmark($(state2_2), Clf.SYGate())
@btime benchmark($(state2_3), Clf.SYGate())
...
println("ISYGate")
@btime benchmark($(state1_1), Clf.ISYGate())
@btime benchmark($(state1_2), Clf.ISYGate())
@btime benchmark($(state1_3), Clf.ISYGate())
@btime benchmark($(state2_1), Clf.ISYGate())
@btime benchmark($(state2_2), Clf.ISYGate())
@btime benchmark($(state2_3), Clf.ISYGate())
